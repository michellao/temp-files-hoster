...
export default function ManageFiles({
  ...
  if (counter > 0) {
    ...
    subContent = uploadedData.map((d) => (
      <DisplayFile key={d.url} uploadedData={d} deleteFile={deleteFile} />
    ));
  }
  ...
  return (
    <Section
      ...
      height={counter <= 0 ? "250px" : undefined}
    >
      <Flex
        justify="center"
        align={counter <= 0 ? "center" : undefined}
        direction="column"
        height="100%"
      >
        {subContent}
